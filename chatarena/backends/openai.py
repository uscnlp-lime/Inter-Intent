...
class OpenAIChat(IntelligenceBackend):
    ...
    def _get_response(self, messages):
        completion = openai.ChatCompletion.create(
            model=self.model,
            messages=messages,
            # temperature=1, use self.temperature for all models except o1
            # max_completion_tokens=self.max_tokens, use parameter max_tokens for all models except o1
            # stop=STOP, uncomment for all models except o1
            n=1 # use n = 5 for all models except o1
        )
