...
class Arena:
    ...
    def step(self) -> TimeStep:
        ...
        timestep = None
        for i in range(2):  # try to take an action for a few times
    ...
    def launch_cli(self, max_steps: int = None, interactive: bool = True,output_file:str=''):
        """
        launch the command line interface
        """
        from chatarena.ui.cli import ArenaCLI
        cli = ArenaCLI(self)
        cli.launch(max_steps=max_steps, interactive=interactive,output_file=output_file)
